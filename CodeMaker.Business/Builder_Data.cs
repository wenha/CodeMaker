...
using CodeMaker.Data.SqlServer;
...
namespace CodeMaker.Business
{
    internal class Builder_Data
    {
        ...
        public Builder_Data(DatabaseType dbType)
        {
        ...
        private string GetUpdateMethod(List<Model.Fields> fields, Model.CodeCreate param)
        {
            ...
            data.Append("\t\t/// </summary>\r\n");
            data.Append("\t\t/// <param name=\"model\">" + param.NameSpace + (string.IsNullOrEmpty(param.NameSpace) ? "" : ".") + param.CNSC.Model + (string.IsNullOrEmpty(param.NameSpace1) ? "" : "." + param.NameSpace1) + "." + param.ClassName + "实体类</param>\r\n");
            data.Append("\t\tpublic int Update(" + param.NameSpace + (string.IsNullOrEmpty(param.NameSpace) ? "" : ".") + param.CNSC.Model + (string.IsNullOrEmpty(param.NameSpace1) ? "" : "." + param.NameSpace1) + "." + param.ClassName + " model)\r\n");
            data.Append("\t\t{\r\n");
        ...
        private string GetAllMethod(List<Model.Fields> fields, Model.CodeCreate param)
        {
            ...
            data.Append("\t\t/// 查询所有记录\r\n");
            data.Append("\t\t/// </summary>\r\n");
            data.Append("\t\tpublic List<" + param.NameSpace + (string.IsNullOrEmpty(param.NameSpace) ? "" : ".") + param.CNSC.Model + (string.IsNullOrEmpty(param.NameSpace1) ? "" : "." + param.NameSpace1) + "." + param.ClassName + "> GetAll()\r\n");
            data.Append("\t\t{\r\n");
            ...
            data.Append("\t\t\tList<" + param.NameSpace + (string.IsNullOrEmpty(param.NameSpace) ? "" : ".") + param.CNSC.Model + (string.IsNullOrEmpty(param.NameSpace1) ? "" : "." + param.NameSpace1) + "." + param.ClassName + "> List = DataReaderToList(dataReader);\r\n");
        ...
        private string GetByKeyMethod(List<Model.Fields> fields, Model.CodeCreate param)
        {
            ...
            data.Append("\t\t/// </summary>\r\n");
            data.Append("\t\tpublic " + param.NameSpace + (string.IsNullOrEmpty(param.NameSpace) ? "" : ".") + param.CNSC.Model + (string.IsNullOrEmpty(param.NameSpace1) ? "" : "." + param.NameSpace1) + "." + param.ClassName + " Get(");
            foreach (var field in Primarykeys)
            {
                data.Append(field.DotNetType + " " + field.Name.ToLower());
                data.Append(field.Name != Primarykeys.Last().Name ? ", " : "");

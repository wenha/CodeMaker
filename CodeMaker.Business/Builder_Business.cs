...
namespace CodeMaker.Business
{
    internal class Builder_Business
    {
        ...
        public Builder_Business(DatabaseType dbType)
        {
        ...
        public string GetBusinessClass(Model.CodeCreate param)
        {
            ...
            business.Append("namespace " + param.NameSpace + (string.IsNullOrEmpty(param.NameSpace) ? "" : ".") + param.CNSC.Business + (string.IsNullOrEmpty(param.NameSpace1) ? "" : "." + param.NameSpace1) + "\r\n");
            business.Append("{\r\n");
            business.Append("\tpublic class " + param.ClassName + "\r\n");
            business.Append("\t{\r\n");
            business.Append("\t\tprivate " + (param.BuilderType == BuilderType.Factory ? param.CNSC.Interface + ".I" : param.CNSC.Data + ".") + param.ClassName + " data" + param.ClassName + ";\r\n");
            business.Append("\t\tpublic " + param.ClassName + "()\r\n");
            business.Append("\t\t{\r\n");
            business.Append("\t\t\tthis.data" + param.ClassName + " = " + (param.BuilderType == BuilderType.Factory ? param.CNSC.Factory + "." + param.ClassName + ".CreateInstance();" : "new " + param.CNSC.Data + "." + param.ClassName + "();") + "\r\n");
            business.Append("\t\t}\r\n");
            ...
            if (param.MethodList.Contains(BuilderMethods.Add))
            {
                ...
                business.Append("\t\t/// 新增\r\n");
                business.Append("\t\t/// </summary>\r\n");
                business.Append("\t\tpublic " + (HasIdentity ? Identitys.First().DotNetType : "int") + " Add(" + param.NameSpace + (string.IsNullOrEmpty(param.NameSpace) ? "" : ".") + param.CNSC.Model + (string.IsNullOrEmpty(param.NameSpace1) ? "" : "." + param.NameSpace1) + "." + param.ClassName + " model)\r\n");
                business.Append("\t\t{\r\n");
            ...
            if (param.MethodList.Contains(BuilderMethods.Update) && HasPrimarykey)
            {
                ...
                business.Append("\t\t/// 更新\r\n");
                business.Append("\t\t/// </summary>\r\n");
                business.Append("\t\tpublic int Update(" + param.NameSpace + (string.IsNullOrEmpty(param.NameSpace) ? "" : ".") + param.CNSC.Model + (string.IsNullOrEmpty(param.NameSpace1) ? "" : "." + param.NameSpace1) + "." + param.ClassName + " model)\r\n");
                business.Append("\t\t{\r\n");
            ...
            if (param.MethodList.Contains(BuilderMethods.SelectAll))
            {
                ...
                business.Append("\t\t/// </summary>\r\n");
                business.Append("\t\tpublic List<" + param.NameSpace + (string.IsNullOrEmpty(param.NameSpace) ? "" : ".") + param.CNSC.Model + (string.IsNullOrEmpty(param.NameSpace1) ? "" : "." + param.NameSpace1) + "." + param.ClassName + "> GetAll()\r\n");
                business.Append("\t\t{\r\n");
            ...
            if (param.MethodList.Contains(BuilderMethods.SelectByKey) && HasPrimarykey)
            {
                ...
                business.Append("\t\t/// </summary>\r\n");
                business.Append("\t\tpublic " + param.NameSpace + (string.IsNullOrEmpty(param.NameSpace) ? "" : ".") + param.CNSC.Model + (string.IsNullOrEmpty(param.NameSpace1) ? "" : "." + param.NameSpace1) + "." + param.ClassName + " Get(");
